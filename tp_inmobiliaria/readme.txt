...
Nuevos conocimientos: if-else, swich, operaciones con variable de tipo double e int, elemento data grid view (sentencia de definición de filas y columnas), foreach, entre otras sentencias y elementos.
